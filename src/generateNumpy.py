...
class generateNumpy:
    ...
    def generateNumpy(hash_train_path, hash_test_path, x_train_path,
        ...
        """
        :hash_train_path: Path to train.txt
        :hash_test_path: Path to test.txt
        ...
        :ls: True = python list is returned
             False = numpy array is returned
        """
        train_zero_pad = []
        masks_zero_pad = []
        test_zero_pad = []
        ...
        if(ls=True):
            return masks_zero_pad, train_zero_pad, test_zero_pad
