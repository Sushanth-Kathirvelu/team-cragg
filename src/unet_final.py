...
""" The dice coef is a metric to calculate the similarilty (intersection)
between the true values and the predictions"""
smooth = 1.
...
def train():
    ...
    print('Fitting model...')
    model.fit(train_npy, masks_npy, batch_size=1, epochs=10000, verbose=1, shuffle=True, callbacks=[es])

    print('predict test data')
    imgs_mask_test = model.predict(test_npy, batch_size=1, verbose=1)

    np.save('/home/rutu/DSP/imgs_mask_test.npy', imgs_mask_test)
...
def save_img():
    ...
    for i in range(imgs.shape[0]):
        ...
        #filename = "/home/rutu/DSP/results1/"+file+".png"
        img.save("/home/rutu/DSP/results1/%d.png"%(i))
